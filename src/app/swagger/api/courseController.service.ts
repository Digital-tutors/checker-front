...
export class CourseControllerService {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSignedUpCoursesUsingGET(page?: number, observe?: 'body', reportProgress?: boolean): Observable<PageOfCourseDTO>;
  public getSignedUpCoursesUsingGET(page?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<PageOfCourseDTO>>;
  public getSignedUpCoursesUsingGET(page?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<PageOfCourseDTO>>;
  public getSignedUpCoursesUsingGET(page?: number, observe: any = 'body', reportProgress: boolean = false): Observable<any> {
    let queryParameters = new HttpParams({ encoder: new CustomHttpUrlEncodingCodec() });
    if (page !== undefined && page !== null) {
      queryParameters = queryParameters.set('page', <any>page);
    }
    ...
    return this.httpClient.request<PageOfCourseDTO>('get', `${this.basePath}/course/my`, {
      params: queryParameters,
      withCredentials: this.configuration.withCredentials,
      headers: headers,
      observe: observe,
