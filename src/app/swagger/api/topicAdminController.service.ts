...
export class TopicAdminControllerService {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public makeArchivedUsingPOST2(id: number, observe?: 'body', reportProgress?: boolean): Observable<TopicDTO>;
  public makeArchivedUsingPOST2(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<TopicDTO>>;
  public makeArchivedUsingPOST2(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<TopicDTO>>;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public makePublishedUsingPOST2(id: number, observe?: 'body', reportProgress?: boolean): Observable<TopicDTO>;
  public makePublishedUsingPOST2(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<TopicDTO>>;
  public makePublishedUsingPOST2(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<TopicDTO>>;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public makeUnpublishedUsingPOST2(id: number, observe?: 'body', reportProgress?: boolean): Observable<TopicDTO>;
  public makeUnpublishedUsingPOST2(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<TopicDTO>>;
  public makeUnpublishedUsingPOST2(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<TopicDTO>>;
