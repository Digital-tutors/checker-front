...
export class TaskAdminControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getDecisionsByCourseAndUserUsingGET(courseId: number, userId: number, page?: number, observe?: 'body', reportProgress?: boolean): Observable<PageOfTaskResultDTO>;
    public getDecisionsByCourseAndUserUsingGET(courseId: number, userId: number, page?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<PageOfTaskResultDTO>>;
    public getDecisionsByCourseAndUserUsingGET(courseId: number, userId: number, page?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<PageOfTaskResultDTO>>;
    public getDecisionsByCourseAndUserUsingGET(courseId: number, userId: number, page?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<PageOfTaskResultDTO>('get',`${this.basePath}/admin/task/user/${encodeURIComponent(String(userId))}/course/${encodeURIComponent(String(courseId))}/all`,
            {
    ...
    /**
     * getTasksForAdminByTopicId
     * 
     * @param id id
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public getTasksForAdminByTopicIdUsingGET(id: number, observe?: 'body', reportProgress?: boolean): Observable<Array<TaskDTO>>;
    public getTasksForAdminByTopicIdUsingGET(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<TaskDTO>>>;
    public getTasksForAdminByTopicIdUsingGET(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<TaskDTO>>>;
    public getTasksForAdminByTopicIdUsingGET(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getTasksForAdminByTopicIdUsingGET.');
        }
        ...
        return this.httpClient.request<Array<TaskDTO>>('get',`${this.basePath}/admin/task/topic/${encodeURIComponent(String(id))}/tasks/all`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public linkWithTopicUsingPUT1(id: number, topicId: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<TaskDTO>('put',`${this.basePath}/admin/task/${encodeURIComponent(String(id))}/task/${encodeURIComponent(String(topicId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public updateTaskExtensionsUsingPUT(extensionId: number, id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<any>('put',`${this.basePath}/admin/task/${encodeURIComponent(String(id))}/extension/${encodeURIComponent(String(extensionId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public updateTaskReplacementsUsingPUT(id: number, replacementId: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<any>('put',`${this.basePath}/admin/task/${encodeURIComponent(String(id))}/replacement/${encodeURIComponent(String(replacementId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public updateTaskSimplificationsUsingPUT(id: number, simplificationId: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<any>('put',`${this.basePath}/admin/task/${encodeURIComponent(String(id))}/simplification/${encodeURIComponent(String(simplificationId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
